...
class AbsensiExport implements FromCollection, WithMapping, WithStyles, WithEvents
{
    ...
    public function __construct($kelas_id = null, $start_date = null, $end_date = null)
    {
    ...
    private function getSiswas()
    {
        $query = Siswa::with(['kelas', 'scans' => function($query) {
