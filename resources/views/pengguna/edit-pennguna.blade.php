        ...
        <div class="body-wrapper-inner">
            <div class="container-fluid">
                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden p-4">
                        ...
                        <div class="position-absolute start-50 translate-middle" style="bottom: -150px;">
                            <div class="position-relative d-inline-block">
                                <img src="../assets/images/profile/user-1.jpg" alt="Foto Profil"
                                    class="rounded-circle border border-3 border-white shadow" width="150"
                                    height="150">
                    ...
                    <!-- Form Edit Pengguna -->
                    <form action="/pengguna/update" method="POST" class="px-3" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label class="form-label">Nama</label>
                            <input type="text" class="form-control" name="nama" value="Rachel Derek" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Username</label>
                            <input type="text" class="form-control" name="username" value="rachelderek" required>
                        </div>
