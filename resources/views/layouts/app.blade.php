        ...
        <aside class="left-sidebar">
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                <ul id="sidebarnav">
                    ...
                    <!-- Jadwal -->
                    <li class="sidebar-item {{ request()->is('jadwal') || request()->is('jadwal/*') ? 'active' : '' }}">
                    ...
                    <!-- Absensi -->
                    <li class="sidebar-item {{ request()->is('absensi') || request()->is('absensi/*') ? 'active' : '' }}">
                    ...
                    <!-- Laporan -->
                    <li class="sidebar-item {{ request()->is('laporan') || request()->is('laporan/*') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('siswas.*') ? 'active' : '' }}">
                        <a class="sidebar-link" href="/siswas">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <!-- Pengguna -->
                    <li class="sidebar-item {{ request()->is('pengguna') || request()->is('pengguna/*') ? 'active' : '' }}">
                                    ...
                                    <div class="message-body">
                                        ...
                                        @auth
                                            <form action="{{ route('logout') }}" method="POST">
                                                @csrf
                                                <button class="btn text-danger d-flex align-items-center gap-2" type="submit">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                        <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/>
                                                        <polyline points="16,17 21,12 16,7"/>
                                                        <line x1="21" y1="12" x2="9" y2="12"/>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (currentPath === '/' || currentPath === '/dashboard') {
                document.querySelector('.sidebar-item a[href="/"]').closest('.sidebar-item').classList.add('active');
            }
        });
    </script>
